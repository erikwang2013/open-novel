...
- **एडमिन पैनल**: सामग्री मॉडरेशन, उपयोगकर्ता प्रबंधन, डेटा आँकड़े (डैशबोर्ड / DAU / रैंकिंग / व्यवहार विश्लेषण /api/stats/behavior), कॉन्फ़िगरेशन प्रबंधन (श्रेणी टैग), मशीन अनुवाद वर्कफ़्लो (DeepL, /api/admin/translate/*, एडमिन का «अनुवाद» पेज + मैनुअल एडिटिंग), ऑडिट लॉग क्वेरी (/api/admin/audit-logs)
