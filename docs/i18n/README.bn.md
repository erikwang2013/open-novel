...
- **অ্যাডমিন প্যানেল**: কন্টেন্ট মডারেশন, ইউজার ম্যানেজমেন্ট, ডেটা পরিসংখ্যান (ড্যাশবোর্ড / DAU / র্যাঙ্কিং / আচরণ বিশ্লেষণ /api/stats/behavior), কনফিগারেশন ম্যানেজমেন্ট (ক্যাটাগরি ট্যাগ), মেশিন ট্রান্সলেশন ওয়ার্কফ্লো (DeepL, /api/admin/translate/*, অ্যাডমিনের «অনুবাদ» পেজ + ম্যানুয়াল এডিটিং), অডিট লগ কোয়েরি (/api/admin/audit-logs)
