...
- **الدفع وVIP**: مدفوعات متعددة القنوات عبر 9 مزودين (Stripe و NOWPayments (USDT) و Razorpay و KOMOJU و PortOne و Mercado Pago و Xendit و PayPal و Alipay)، اشتراك وتجديد خطط VIP، توجيه طرق الدفع حسب اللغة (WeChat Pay غير متكامل، يتطلب أهلية التاجر)
