...
- **لوحة الإدارة**: مراجعة المحتوى، إدارة المستخدمين، إحصائيات البيانات، إدارة الإعدادات، صفحة استعلام سجلات التدقيق (ترقيم الصفحات + تصفية بمعايير متعددة)
- **الدفع وVIP**: مدفوعات متعددة القنوات عبر 10 مزودين (Stripe و NOWPayments (USDT) و Razorpay و KOMOJU و PortOne و Mercado Pago و Xendit و PayPal و Alipay و WeChat Pay Global)، اشتراك وتجديد خطط VIP، توجيه طرق الدفع حسب اللغة (WeChat Pay Global متكامل، WeChat Pay المحلي غير متكامل، يتطلب أهلية التاجر في الصين)
